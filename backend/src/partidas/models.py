...
class Partida(Base):
    ...
    nome_partida = Column(String, nullable=False)
    ...
    placar_final_dupla_a = Column(Integer, nullable=True, default=0)
    placar_final_dupla_b = Column(Integer, nullable=True, default=0)
